    ...
    def build_invalidation_document(self, request: InvalidateRequest) -> dict:
        ...
        return {
            ...
            "emisor": {
                ...
                "nomEstablecimiento": request.nombre_comercial_emisor or request.nombre_emisor,
                "codEstableMH": request.cod_establecimiento or "M001",
                "codEstable": request.cod_establecimiento or "M001",
                "codPuntoVentaMH": request.cod_punto_venta or "P001",
                "codPuntoVenta": request.cod_punto_venta or "P001",
                "telefono": request.telefono_emisor or "00000000",
                "correo": request.correo_emisor or "",
            },
            "documento": {
                ...
                "tipoDocumento": request.tipo_documento_receptor or "36",
                "numDocumento": request.nit_receptor,
                "nombre": request.nombre_receptor,
                "telefono": request.telefono_receptor or "00000000",
                "correo": request.correo_receptor or "",
            },
            "motivo": {
